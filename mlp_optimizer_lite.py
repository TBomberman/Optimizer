...
def do_optimize(nb_classes, data, labels):
    ...
    train_indexes, val_indexes = train_test_split(indexes, train_size=0.7, test_size=0.3, shuffle=True)
    X_train = data[train_indexes]
    Y_train = labels[train_indexes]
    val_indexes, test_indexes = train_test_split(val_indexes, train_size=0.5, test_size=0.5, shuffle=True)
