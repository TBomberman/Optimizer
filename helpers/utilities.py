...
def surface3D(X,Y,Z,varnames,file=None,show=None):
    ...
    from matplotlib.pyplot import gca, figure, colorbar, savefig,xlabel, ylabel
...
def heatmap(data,labels=None,file=None):
    from  matplotlib.pyplot import imshow,savefig,cm,colorbar,figure
    #import Image
...
def scatterdens_plot(x,y,flag,file=None,show=None):
    ...
    from matplotlib.pyplot import setp,getp, savefig, figure
...
#    data=csv2libsvmdata(datafile)
    from helpers.utilities import read_descriptors
