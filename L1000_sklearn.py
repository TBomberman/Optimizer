...
data = np.loadtxt('/home/mllamosa/Data/x.csv',delimiter=",")
y = np.loadtxt('/home/mllamosa/Data/y_class.csv')
...
#model = dd.Model(data=np.hstack((data, y)),function=ml.Plsr(), partition=partition,nfo=3)
