...
def compare_predictions_with_nate():
    ...
    print_stats(up1_true, 0.01, "up", up_predictions, 0.624)
    print_stats(up5_true, 0.05, "up", up_predictions) #, 0.624)
    print_stats(up10_true, 0.1, "up", up_predictions, 0.624)
    print_stats(up15_true, 0.15, "up", up_predictions, 0.624)
    print_stats(up20_true, 0.2, "up", up_predictions, 0.624)
    ...
    print_stats(down1_true, 0.01, "down", down_predictions, 0.599)
    print_stats(down5_true, 0.05, "down", down_predictions, 0.599)
    print_stats(down10_true, 0.10, "down", down_predictions, 0.599)
    print_stats(down15_true, 0.15, "down", down_predictions, 0.599)
    print_stats(down20_true, 0.2, "down", down_predictions, 0.599)
